...
const navItems = [
  ...
  { to: "/teams", label: "Applicants Status", icon: UsersRoundIcon },
 ...
 { to: "/freelancer-candidates", label: "Freelancer Candidates", icon: IoMdPeople  },
{ to: "/assigned-freelancer-candidates", label: "Assigned Talent", icon: IoMdCodeWorking }
