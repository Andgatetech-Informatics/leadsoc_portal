...
const navItems = [
  ...
  { to: "/list-of-invoices", label: "All Invoices", icon: ListCheck },
   { to: "/companies", label: "Companies", icon: CheckCircle },
   { to: "/invoice", label: "Create new invoice", icon: FaFileInvoice },
