...
const CreatePostJob = ({ onSubmit, closeModal }) => {
  ...
  const [jobId, setJobId] = useState("JD-001");
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              value={jobId}
              readOnly
              className="w-full p-2 bg-gray-100 border rounded-lg text-sm"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="relative flex flex-col" ref={visRef}>
              ...
              <button
                ...
                className="w-full p-2 bg-white border border-gray-300 rounded-lg flex justify-between items-center text-sm hover:border-gray-400 transition"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div>
            ...
            <input
              ...
              className="w-full p-2 mt-2 border rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600"
              required
            />
            {formErrors.title && (
