...
const AssignedFreelancerCandidates = () => {
      ...
      <div className=" mx-auto">
        ...
        {!loading && filteredCandidates.length === 0 && (
          <div className="text-center text-gray-500 py-10">
            No assigned freelancer candidates candidates found.
          </div>
        )}
      </div>
    </div>
...
export default AssignedFreelancerCandidates;
